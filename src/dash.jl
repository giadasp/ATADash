function ATA_app()
    ...
    Dash.callback!(
        ...
        if n_click_state > 0
            message = ["success", ""]
            try
                message = ATA.add_friends!(ATAmodel)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_click_state > 0
            message = ["success", ""]
            try
                message = ATA.add_enemies!(ATAmodel)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            ...
            try
                message =
                    ATA.add_overlap!(ATAmodel; overlap_file = ol_file, overlap_delim = ol_delim)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            message = ["success", ""]
            try
                message = ATA.add_exp_score!(ATAmodel)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            message = ["success", ""]
            try
                message = ATA.group_by_friends!(ATAmodel)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            message = ["success", ""]
            try
                message = ATA.add_obj_fun!(ATAmodel)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
